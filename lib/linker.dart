...
class Intent {
  ...
  static const String ACTION_DATA_USAGE = "android.settings.ACTION_DATA_USAGE_SETTINGS";
...
class Linker {
  ...
  static Future<ActivityResult> openMobileDataSettings(int requestCode) async {
    dynamic value = await _channel.invokeMethod("openMobileDataSettings", requestCode);
    print("\n\n\n Value : $value \n\n\n");
    return new ActivityResult.fromMap(value);
  }
